export default function Portfolio() {
  return (
    ...
    # ...
`}</code></pre>
      <p className="mb-4 font-semibold">[Aquí iría una imagen de los gráficos de las acciones]</p>
    ...
    # ...
`}</code></pre>
      <p className="mb-4 font-semibold">[Aquí iría una imagen de los resultados de la regresión]</p>
    ...
    # ...
`}</code></pre>
      <p className="mb-4 font-semibold">[Aquí iría una imagen de la proyección de precios]</p>
